...
export function FileUpload({
  file, onFileChange, onUpload, onRetry, onCancel, loading, error, progress,
    ...
    >
      ...
      <div className="relative p-14 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
          <Button variant="secondary" onClick={() => inputRef.current?.click()} disabled={loading}>{t.chooseFile}</Button>
          {loading ? (
